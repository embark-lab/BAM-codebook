...
`ctq_emo_abuse` (CTQ emotional abuse subscale sum)

`ctq_phys_abuse` (CTQ pysical abuse subscale sum)

`ctq_sex_abuse` (CTQ sexual abuse subscale sum)

`ctq_emo_neglect`(CTQ emotional neglect subscale sum )

`ctq_phys_neglect`(CTQ physical neglect subscale sum)

`ctq_minimize` (CTQ mimnimization score)
