...
### Scoring 
We start by cleaning and importing data from the data collection form, which captures demographic variables in this study. We select variables that are part of the data collection form (prefix 'dcf') and clean these variables from an original set of 61 variables down to 19 variables to be included in the master dataset. 

We calculate Age in years and remove birthdate (HIPPA Identifier) from the data set. 

We change assessment date to only capture month and year of assessment for de-identifiacation. 
